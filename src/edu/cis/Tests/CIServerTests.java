...
public class CIServerTests extends ConsoleProgram
{
    ...
    public void run()
    {
        ...
        p.addParam(CISConstants.ORDER_ID_PARAM, "mlp99"); //random order id
...
//
        ...
        String itemString3 = "CISUser{userID='qwert5', name='latisha', yearLevel='y13', orders=[Order{itemID='33a', type='breakfast', orderID='9078ppp'}], money=28.0}";
